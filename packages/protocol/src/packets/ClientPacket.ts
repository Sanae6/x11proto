...
export enum Requests {
    ...
    ChangeKeyboardControl = 101,
    GetKeyboardControl = 102,
    Bell = 103,
    ChangePointerControl = 104,
    GetPointerControl = 105,
    SetScreenSaver = 106,
    GetScreenSaver = 107,
    ChangeHosts = 108,
    ListHosts = 109,
    SetAccessControl = 110,
    KillClient = 111,
    RotateProperties = 112,
    ForceScreenSaver = 113,
    SetPointerMapping = 114,
    GetPointerMapping = 115,
    SetModifierMapping = 116,
    GetModifierMapping = 117,
    NoOp = 127
}
